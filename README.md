...
See [TERMS\_OF\_USE.md](TERMS_OF_USE.md)
...
You can get rurima binary (staticly linked) for arm64, armv7, armhf, riscv64, i386, loong64, s390x, ppc64le and x86\_64 from the release page.\
...
rurima needs tar, xz, gzip, file, you can find these static binary for aarch64, armv7, x86\_64, i386 or riscv64 in：\
